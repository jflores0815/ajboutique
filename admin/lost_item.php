...
$query="SELECT a.first_name, a.last_name, b.transaction_no, b.date, b.client_id, b.tracking_no, b.BC, total, b.status 
                                                                    ...
                                                                    WHERE (b.status = 7 OR b.status = 7)
...
?>                     
				...
				<td><center>
                        ...
                        <td style="width:30%;">
                          ...
                          <button style="background: #c6e2ed;color: #ffffff;border-radius: 7px;font-size: 15px;padding: 5px 10px 5px 10px;cursor: pointer;" class="btn-shipped btn-block"> <a href="http://jrs-express.com/Home/Tracking"><i class="icon-plane"></i>Track Order</a></button>
