...
$query="SELECT * FROM tbl_customization t1, tbl_customizationimage t2 where t1.customize_id=t2.ID AND statuss='pending'";
...
?>                     
					 <tr>
						...
						<b> Allounce:</b> <?php echo $row['Allowance']; ?> inch<br>
						  ...
						  <td><form action="pendingrequest.php?id=<?php echo $row['ID']; ?>" method="POST" onsubmit='return deletethiss()'>
