...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Order Verification </a> </div>
    <h1>Verification</h1>
  </div>
						...
						<td>Php <?php echo number_format($row['price'],2);  ?>	</td>
						   ...
						   <td><?php echo $row['confirmation']; ?></td>
							    <td><?php echo $row['status']; ?></td>
                           	  ...
                           	  <td><a href="photoproduct.php?id=<?php echo $row['ID']; ?>"><img src="<?php echo $row['images']?>" width="100px;" height="80px;"id="photos" >
						  </a></td>
