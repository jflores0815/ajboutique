...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2023 at 06:26 AM
...
(122, '37', '99', '350.00', 1, '0.50'),
(123, '37', '94', '450.00', 1, '455.00');
...
(130, '', 'Add Product', 'Product Product', '2022/08/30 16:00:00');
...
(217, '000217', 37, 94, '2022-08-23 13:22:45', 1, 0, '');
...
(94, 2, 'ITEM00016', 'Moisturizing Cream', 'Clinically proven to provide immediate, long-lasting hydration that soothes dry, sensitive skin', 450.00, 455.00, '../images/cream.jpg', 95, '10'),
...
CREATE TABLE IF NOT EXISTS `tbl_countorder` (
...
(0, '000217', '2022-08-23 13:22:45', '2022-08-23 05:22:45', '2022-08-23 05:22:45', 37, 450.00, NULL, 'None', 'None', 0.00, 0, '', ''),
...
--
ALTER TABLE `addcart`
  MODIFY `idd` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=124;
--
...
--
ALTER TABLE `audittrail`
  MODIFY `user_id` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=131;
--
...
--
ALTER TABLE `tbl_countorder`
  MODIFY `order_id` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=208;
--
