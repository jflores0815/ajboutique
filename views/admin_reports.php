...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" onLoad="reset()">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    $numNewOrders = "SELECT * FROM transactions WHERE status = 0;";
    ...
    ?>
    	...
    	<a class="nav-link dropdown-toggle mr-lg-2" id="alertsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    		...
    		<span class="indicator text-warning d-none d-lg-block"></span>
        ...
        <?php include 'reserved_notification.php' ?>
    		...
    		$fetchOrders = "SELECT * FROM transactions WHERE status = 0";
  ...
  <div class="content-wrapper">
        ...
        <div class="col-12">
          ...
          <h1>Reports</h1>
            ...
            <div class="card-header">
              ...
              <table style="float: center">
                  ...
                  <tr>
                      ...
                      <!--<td><form action="../reports/inventory_report.php"><input type="submit" class="btn btn-primary" value="Generate Inventory Report"/></form></td>-->

                      

                      <td style="width:25%;">

                          <button class="btn-delete btn-block" data-toggle="modal" data-target="#inventoryReport"> Generate Inventory Report</button></td></br>

                      <td style="width:25%;">

                          <button class="btn-view btn-block" data-toggle="modal" data-target="#salesReport">

                              Generate Sales Report</button></td>
            ...
            <!-- Inventory Report Modal -->
                    ...
                    <div class="modal fade" id="inventoryReport" tabindex="-1" role="dialog" aria-labelledby="inventoryReportLabel" aria-hidden="true">
                      ...
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-header">
                            ...
                            <h5 class="modal-title" id="inventoryReportLabel"><i class="icon-edit"> </i>Inventory Report</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="../reports/inventory_report.php">

                                <table>

                                    <tr>

                                        <td><h6>Generate report by: </h6>

                                            <select id="invOpt" onchange="changeAttr('inventoryInput', 'invOpt')">
                                            ...
                                            <input type="hidden" id="invAction" name="action" value="weekly"/>
                                    ...
                                    <tr>
                                        ...
                                        <td><h6>Select date: </h6><input id="inventoryInput" type="date" name="date"/></td>

                                    </tr>

                                    <tr>

                                        <td><input class="btn btn-primary" type="submit" value="Generate" /></td>
            ...
            <!-- Sales Report Modal -->
                    ...
                    <div class="modal fade" id="salesReport" tabindex="-1" role="dialog" aria-labelledby="salesReportLabel" aria-hidden="true">
                      ...
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-header">
                            ...
                            <h5 class="modal-title" id="salesReportLabel"><i class="icon-edit"> </i>Sales Report</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="../reports/sales_report.php">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><h6>Generate report by: </h6>
                                            ...
                                            <select id="salesOpt" onchange="changeAttr('salesInput', 'salesOpt')">
                                            ...
                                            <input type="hidden" id="salesAction" name="action" value="weekly"/>
                                    ...
                                    <tr>
                                        ...
                                        <td><h6>Select date: </h6><input id="salesInput" type="date" name="date"/></td>
    ...
    <script type="text/javascript">
        ...
        function changeAttr(report, opt) {
            ...
            if(report == "salesInput") {

                input = document.getElementById("salesInput");

                action = document.getElementById("salesAction");

            } else if(report == "inventoryInput") {

                input = document.getElementById("inventoryInput");

                action = document.getElementById("invAction");
            ...
            var strOpt = e.options[e.selectedIndex].text;
        ...
        function reset() {
            ...
            var e1 = document.getElementById("invOpt");

            var e2 = document.getElementById("salesOpt");

            

            input1 = document.getElementById("salesInput");

            input2 = document.getElementById("inventoryInput")
            ...
            e1.options[e.selectedIndex].value == 0;

            e2.options[e.selectedIndex].value == 0;
